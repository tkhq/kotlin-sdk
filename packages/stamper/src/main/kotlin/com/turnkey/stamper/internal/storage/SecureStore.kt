...
object SecureStore {
    ...
    private fun decrypt(b64: String): ByteArray {
        ...
        if (blob.size < IV_LEN + 16) throw TurnkeyStamperError.InvalidCiphertext()
    ...
    fun set(
        ...
        val enc = try { encrypt(data) } catch (t: Throwable) {
            throw TurnkeyStamperError.KeychainAddFailed(-1)
        }
    ...
    fun get(
        ...
        return try { decrypt(b64) } catch (t: Throwable) {
            throw TurnkeyStamperError.KeychainFetchFailed(-1)
        }
    }
    ...
    fun listKeys(
        ...
        throw TurnkeyStamperError.KeychainListKeysFailed(-1)
    }
    ...
    fun delete(
        ...
        if (!ok) throw TurnkeyStamperError.KeychainDeleteFailed(-1)
    }
