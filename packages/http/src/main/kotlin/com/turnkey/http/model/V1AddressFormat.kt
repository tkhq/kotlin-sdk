 ...
 */
@Serializable
enum class V1AddressFormat(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is V1AddressFormat) "$data" else null

        /**
         * Returns a valid [V1AddressFormat] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): V1AddressFormat? = data?.let {
