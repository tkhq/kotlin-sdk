...
object VersionedActivityTypes {
    val map: Map<String, Triple<String, String, String>> = mapOf(
        ...
        "ACTIVITY_TYPE_EMAIL_AUTH" to Triple("ACTIVITY_TYPE_EMAIL_AUTH_V2", "v1EmailAuthIntentV2", "v1EmailAuthResult"),
        ...
        "ACTIVITY_TYPE_INIT_OTP_AUTH" to Triple("ACTIVITY_TYPE_INIT_OTP_AUTH_V2", "v1InitOtpAuthIntentV2", "v1InitOtpAuthResultV2"),
        "ACTIVITY_TYPE_INIT_USER_EMAIL_RECOVERY" to Triple("ACTIVITY_TYPE_INIT_USER_EMAIL_RECOVERY", "v1InitUserEmailRecoveryIntent", "v1InitUserEmailRecoveryResult"),
        "ACTIVITY_TYPE_INIT_OTP" to Triple("ACTIVITY_TYPE_INIT_OTP", "v1InitOtpIntent", "v1InitOtpResult"),
    )
