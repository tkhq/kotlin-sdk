...
//    implementation("io.github.ethankonk:passkey:0.1.0-SNAPSHOT")
    ...
    implementation("com.turnkey:http:0.1.0")
    implementation("com.turnkey:types:0.1.0")
    implementation("com.turnkey:stamper:0.1.0")
    implementation("com.turnkey:sdk-kotlin:0.1.0")
    implementation("com.turnkey:passkey:0.1.0")
